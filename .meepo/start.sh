...
echo ''
echo 'Prompt:'
echo 'You are on a feature branch (not main). Create a file called hello.txt in the current directory 
...
```bash
git add -A
git commit -m "Initial hello.txt file"
```
'
echo ''
echo '=== Claude Output ==='
claude --dangerously-skip-permissions --print 'You are on a feature branch (not main). Create a file called hello.txt in the current directory 
containing the text '\''Hello from Claude'\''.
